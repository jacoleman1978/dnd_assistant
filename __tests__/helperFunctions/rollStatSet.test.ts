...
describe("rollStat", () => {
    test("should throw an error if minimumStatAllowed is less than 3", () => {
        expect(() => rollStat(2)).toThrow("Minimum stat allowed must be 3 or greater for rollStat.");
    });

    test("should throw an error if minimumStatAllowed is greater than 18", () => {
        expect(() => rollStat(19)).toThrow("Minimum stat allowed must be 18 or less for rollStat.");
    });
...
describe("rollStatSet", () => {
    test("should throw an error if minimumStatAllowed is less than 3", () => {
        expect(() => rollStatSet(2)).toThrow("Minimum stat allowed must be 3 or greater for rollStatSet.");
    });

    test("should throw an error if minimumStatAllowed is greater than 18", () => {
        expect(() => rollStatSet(19)).toThrow("Minimum stat allowed must be 18 or less for rollStatSet.");
    });

    test("should throw an error if minimumStatSum is less than 18", () => {
        expect(() => rollStatSet(3, 17)).toThrow("Minimum stat sum must be 18 or greater for rollStatSet.");
    });

    test("should throw an error if minimumStatSum is greater than 108", () => {
        expect(() => rollStatSet(3, 109)).toThrow("Minimum stat sum must be 108 or less for rollStatSet.");
    });

    test("should throw an error if atLeastOneStatEqualToOrGreaterThan is less than 3", () => {
        expect(() => rollStatSet(3, 18, 2)).toThrow("Minimum stat allowed must be 3 or greater for rollStatSet.");
    });

    test("should throw an error if atLeastOneStatEqualToOrGreaterThan is greater than 18", () => {
        expect(() => rollStatSet(3, 18, 19)).toThrow("Minimum stat allowed must be 18 or less for rollStatSet.");
    });
